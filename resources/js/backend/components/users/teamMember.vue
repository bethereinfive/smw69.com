    ...
    <div class="layout-content" style="margin-bottom: 100px;">
            ...
            <div class="bank_datails" style="    margin-top: 60px;    padding: 32px 19px; ">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mt-4 text-center" style="font-size: 20px;">
                        <span>{{ parseFloat(teamdetails.refer_commisition).toFixed(2)  }}</span> <br>
                        <span>বন্টন কমিশন</span>
                    </div>

                    <div class="col-md-6 mt-4 text-center" style="font-size: 20px;">
                        <span>{{ parseFloat(teamdetails.refer_task_bonus+teamdetails.refer_commisition).toFixed(2)  }}</span> <br>
                        <span>মোট কমিশন</span>
                    </div>

                    <div class="col-md-6 mt-4 text-center" style="font-size: 20px;">
                        <span>{{ teamdetails.Direct_Invites }}</span> <br>
                        <span>প্রথম শ্রেণির সদস্য</span>
                    </div>

                    <div class="col-md-6 mt-4 text-center" style="font-size: 20px;">
                        <span>{{ teamdetails.total_member }}</span> <br>
                        <span>দলের আকার</span>
                    </div>
